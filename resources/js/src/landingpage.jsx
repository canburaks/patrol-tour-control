...
const LandingPage = props => {
	...
	return (
		<>
			<section className="py-20 bg-gray-50 min-h-4/5">
				<div className="container items-center max-w-6xl px-6 mx-auto sm:px-16 md:px-32 lg:px-16">
					<div className="flex-wrap flex-row-reverse sm:flex-row sm:flex items-center mx-3">
						<div className="order-1 w-full px-3 lg:w-1/2 lg:order-0">
							<div className="w-full lg:max-w-md">
								...
								<p className="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">
									Akıllı güvenlik sistemlerimiz ile personelinizin doğru zamanda
									doğru kontrolü yaptığından emin olun.
								</p>
								<ul>
									<li className="flex items-center py-2 space-x-4 xl:py-3">
										...
										<span className="font-medium text-gray-500">
											Kırılan ve bozulan tom kalemlerine elveda
										</span>
									</li>
									<li className="flex items-center py-2 space-x-4 xl:py-3">
										<svg
										...
										<span className="font-medium text-gray-500">
											Tüm kontrol geçmişini görüntüleyin
										</span>
									</li>
									<li className="flex items-center py-2 space-x-4 xl:py-3">
										<svg
										...
										<span className="font-medium text-gray-500">
											İnternet olan her yerden anlık kontrol imkanı
										</span>
									</li>
								</ul>
							</div>
						...
						<div className="w-full sm:px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0 relative">
								...
								<div className="max-w-sm text-center mx-auto ">
									<div className="mb-4 px-2 sm:px-6 py-8 bg-white rounded-xl shadow-2xl">
										...
										{ACCOUNT_DATA?.AUTH ? (
											<Link
												to="/dashboard"
												className="mb-2 w-full py-4 px-4 bg-teal-600 hover:bg-teal-700 rounded text-sm font-bold text-gray-50">
							...
							<img
								className="mx-auto sm:max-w-sm lg:max-w-full absolute right-4 top-4"
